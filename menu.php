        ...
        <div class="row grid">
          <div class="col-sm-6 col-lg-4 all Lok-lak">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="<?= $TagenameProductTwo['earing'] ?>" alt="Lok lak">
                </div>
                <div class="detail-box">
                  ...
                  <p>
                    Lok lak is a dish of stir-fried beef, chicken, or shrimp served with rice, salad, and a tangy dipping sauce. It is a French-influenced dish that is popular for celebrations and street food in Cambodia
                  </p>
                  <div class="options">
                    <h6>
                      10000 (Real)
        ...
        <div class="owl-carousel client_owl-carousel">
          <div class="item">
            <div class="box">
              ...
              <div class="img-box">
                <img src="images/Ramy_n.jpg" alt="" class="box-img">
              </div>
            </div>
          </div>
          <div class="item">
...
First, let me tell you about nom pang, which is a Cambodian sandwich. Nom pang is made with a crispy baguette that is filled with various meats, such as pork, chicken, or beef, and topped with fresh vegetables, such as cucumber, carrot, onion, and cilantro. The sandwich is also seasoned with mayonnaise, pate, soy sauce, and chili sauce. Nom pang is a perfect snack for any time of the day, and you can find it at many street stalls or cafes in Cambodia. Nom pang is very satisfying and flavorful, and it’s one of the most popular street foods in Cambodia.
              ...
              <div class="img-box">
                <img src="images/ice-bear.jpg" alt="" class="box-img">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 footer-col">
          <div class="footer_detail">
            ...
            <div class="footer_social">
              ...
              <a href="https://twitter.com/Ramy48506866144">
                <i class="fa fa-twitter" aria-hidden="true"></i>
              </a>
              <a href="https://www.linkedin.com/public-profile/settings?trk=d_flagship3_profile_self_view_public_profile">
                <i class="fa fa-linkedin" aria-hidden="true"></i>
              </a>
              <a href="https://www.instagram.com/rameee_are_mee/?fbclid=IwAR3SWRHvtML4u6dzFJLaEqdSdx_2Eyy9mTw_jdBC9UVNe9OmEYYz1u1qxME">
